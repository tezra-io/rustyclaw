...
Python companion package for [RustyClaw](https://github.com/tezra-io/rustyclaw) — LangGraph-based tool calling for consistent LLM agent execution.
...
| Feature | Rust RustyClaw | rustyclaw-tools |
|---------|---------------|----------------|
...
Use **Rust RustyClaw** for production edge deployments. Use **rustyclaw-tools** when you need guaranteed tool calling consistency or Python ecosystem integration.
