...
```bash
# Check config
cat ~/.rustyclaw/config.toml | grep -A 5 telegram
...
| Health check | <5s | `time rustyclaw channel doctor` |
...
5. **Monitor logs** for any issues:
   ...
   rustyclaw daemon
   # or
   RUST_LOG=info rustyclaw channel start
   ```
...
- Issues: https://github.com/theonlyhennygod/rustyclaw/issues
