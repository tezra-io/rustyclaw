...
fn open_skills_enabled() -> bool {
    if let Ok(raw) = std::env::var("RUSTYCLAW_OPEN_SKILLS_ENABLED") {
    ...
    if !readme.exists() {
        std::fs::write(
            ...
            "# RustyClaw Skills\n\n\
             ...
             ```bash\n\
             rustyclaw skills install <github-url>\n\
    ...
    match command {
        crate::SkillCommands::List => {
            ...
            if skills.is_empty() {
                ...
                println!();
                println!("  Or install: rustyclaw skills install <github-url>");
            } else {
        ...
        crate::SkillCommands::Install { source } => {
            ...
            if source.starts_with("https://") || source.starts_with("http://") {
                ...
                if output.status.success() {
                    ...
                    println!("  Restart `rustyclaw channel start` to activate.");
                } else {
