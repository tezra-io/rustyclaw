...
pub use schema::{
    ...
    CronConfig, DelegateAgentConfig, DiscordConfig, DockerRuntimeConfig, ElixirConfig,
    EmbeddingRouteConfig, EstopConfig, FeishuConfig, GatewayConfig, HardwareConfig,
    HardwareTransport, HeartbeatConfig, HermesConfig, HooksConfig, HttpRequestConfig,
    ...
    SessionBridgeAgentConfig, SessionBridgeConfig, SkillsConfig, SkillsPromptInjectionMode,
