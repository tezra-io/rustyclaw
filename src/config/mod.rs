...
pub use schema::{
    ...
    HermesConfig, HooksConfig, HttpRequestConfig, IMessageConfig, IdentityConfig, LarkConfig,
    ...
    SecretsConfig, SecurityConfig, SessionBridgeAgentConfig, SessionBridgeConfig, SkillsConfig,
