...
/// <FunctionCall>
/// file_read
/// <code>path>/Users/kylelampa/Documents/rustyclaw/README.md</code>
/// </FunctionCall>
/// ```
...
/// Map tool name aliases from various LLM providers to RustyClaw tool names.
...
/// to. This function encodes the mapping for known RustyClaw tools.
...
fn parse_tool_calls(response: &str) -> (String, Vec<ParsedToolCall>) {
    ...
    // 2. RustyClaw tool-call tags (<tool_call>, <toolcall>, <tool-call>)
