...
const SNAPSHOT_HEADER: &str = "# 🧠 RustyClaw Memory Snapshot\n\n\
    > Auto-generated by RustyClaw. Do not edit manually unless you know what you're doing.\n\
...
mod tests {
    ...
    fn parse_snapshot_basic() {
        let input = r#"# 🧠 RustyClaw Memory Snapshot

> Auto-generated by RustyClaw.
...
I am RustyClaw, a self-preserving AI agent.
...
"#;
    ...
    fn parse_snapshot_empty() {
        let input = "# 🧠 RustyClaw Memory Snapshot\n\n> Nothing here.\n";
        let entries = parse_snapshot(input);
