...
//! sketch code and calls this tool. RustyClaw compiles and uploads it — no
...
impl Tool for ArduinoUploadTool {
    ...
    async fn execute(&self, args: Value) -> anyhow::Result<ToolResult> {
        ...
        let sketch_name = "rustyclaw_sketch";
        let temp_dir = std::env::temp_dir().join(format!("rustyclaw_{}", uuid::Uuid::new_v4()));
