...
/// Handle `rustyclaw peripheral` subcommands.
    ...
    match cmd {
        crate::PeripheralCommands::List => {
            ...
            if boards.is_empty() {
                ...
                println!();
                println!("Add one with: rustyclaw peripheral add <board> <path>");
                println!("  Example: rustyclaw peripheral add nucleo-f401re /dev/ttyACM0");
                println!();
