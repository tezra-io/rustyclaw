...
const OTP_ISSUER: &str = "RustyClaw";
...
impl OtpValidator {
    pub fn from_config(
        ...
        let secret_path = secret_file_path(rustyclaw_dir);
...
pub fn secret_file_path(rustyclaw_dir: &Path) -> PathBuf {
    rustyclaw_dir.join(OTP_SECRET_FILE)
}
