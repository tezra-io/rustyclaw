...
| Scenario | Command |
|----------|---------|
| I have an API key, want fastest setup | `rustyclaw onboard --api-key sk-... --provider openrouter` |
| I want guided prompts | `rustyclaw onboard --interactive` |
| Config exists, just fix channels | `rustyclaw onboard --channels-only` |
| Config exists, I intentionally want full overwrite | `rustyclaw onboard --force` |
| Using subscription auth | See [Subscription Auth](../../README.md#subscription-auth-openai-codex--claude-code) |

## Onboarding and Validation

- Quick onboarding: `rustyclaw onboard --api-key "sk-..." --provider openrouter`
- Interactive onboarding: `rustyclaw onboard --interactive`
...
- Validate environment: `rustyclaw status` + `rustyclaw doctor`
