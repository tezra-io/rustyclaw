...
RustyClaw hỗ trợ các model GLM của Z.AI thông qua các endpoint tương thích OpenAI.
Hướng dẫn cấu hình thực tế theo provider hiện tại của RustyClaw.

## Tổng quan

RustyClaw hỗ trợ sẵn các alias và endpoint Z.AI sau đây:
...
### Kiểm tra bằng RustyClaw CLI

```bash
# Test agent directly
echo "Hello" | rustyclaw agent
