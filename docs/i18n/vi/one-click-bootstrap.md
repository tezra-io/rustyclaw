...
Cách cài đặt và khởi tạo RustyClaw nhanh nhất.
...
Mặc định là **chỉ ứng dụng** (build/cài RustyClaw), yêu cầu Rust toolchain sẵn có.
...
Lệnh này build image RustyClaw cục bộ và chạy thiết lập trong container, lưu config/workspace vào `./.rustyclaw-docker`.
