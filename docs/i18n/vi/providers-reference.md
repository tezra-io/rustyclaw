# Tài liệu tham khảo Providers — RustyClaw
...
3. Biến môi trường dự phòng chung: `RUSTYCLAW_API_KEY`, sau đó là `API_KEY`
...
- Sau khi chuẩn hóa multimodal, RustyClaw gửi payload hình ảnh qua trường `messages[].images` gốc của Ollama.
- Nếu chọn provider không hỗ trợ vision, RustyClaw trả về lỗi rõ ràng thay vì âm thầm bỏ qua hình ảnh.
...
- Khám phá model: `rustyclaw models refresh --provider nvidia`
