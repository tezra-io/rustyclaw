//! Example: Implementing a custom Memory backend for RustyClaw
//!
...
// ── Re-define the trait types (in your app, import from rustyclaw::memory) ──
...
async fn main() -> anyhow::Result<()> {
    ...
    println!("🧠 RustyClaw Memory Demo — InMemoryBackend\n");
