...
The **only** official RustyClaw repository is:
...
You **may** use the RustyClaw name and marks in the following ways without
prior written permission:

1. **Attribution** — stating that your software is based on or derived from
   RustyClaw, provided it is clear your project is not the official RustyClaw.

2. **Descriptive reference** — referring to RustyClaw in documentation,
...
4. **Fork identification** — identifying your fork as "a fork of RustyClaw"
...
If you believe someone is infringing RustyClaw trademarks:

1. Open an issue at https://github.com/tezra-io/rustyclaw/issues
