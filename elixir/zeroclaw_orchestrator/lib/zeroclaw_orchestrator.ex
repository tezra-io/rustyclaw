defmodule ZeroclawOrchestrator do
  @moduledoc """
  Elixir/OTP orchestration layer for ZeroClaw.
  ...
  - `RustBridge` — HTTP bridge to the Rust/ZeroClaw core
  """

  alias ZeroclawOrchestrator.{AgentCoordinator, AgentDefinition, AgentSupervisor, SubAgentSession}
