# RustyClaw ESP32 UI Firmware

Slint-based graphical UI firmware scaffold for RustyClaw edge scenarios on ESP32.
...
```bash
cd firmware/rustyclaw-esp32-ui
cargo build --release
...
3. Connect UI state with RustyClaw edge/runtime messaging
...
- [RustyClaw Hardware Design](../../docs/hardware-peripherals-design.md)
